...
const heroImage = "/images/culinary.jpg";

const fallbackArticles: PotensiArticle[] = [
  {
    id: "fallback-kuliner-munggangsari-1",
    title: "Menjelajahi Ragam Kuliner Munggangsari: Warung Hangat dan Cita Rasa Desa",
    description:
      "Desa Munggangsari menyimpan cerita kuliner yang dekat dengan kehidupan warga. Deretan warung lokal menjadi ruang singgah, tempat cita rasa rumahan, obrolan hangat, dan keramahan desa bertemu setiap hari.",
    articleUrl: "#",
    image: heroImage,
    category: "Kuliner Lokal",
  },
  {
    id: "fallback-kuliner-munggangsari-2",
    title: "Menjelajahi Ragam Kuliner Munggangsari: Warung Hangat dan Cita Rasa Desa",
    description:
      "Desa Munggangsari menyimpan cerita kuliner yang dekat dengan kehidupan warga. Deretan warung lokal menjadi ruang singgah, tempat cita rasa rumahan, obrolan hangat, dan keramahan desa bertemu setiap hari.",
    articleUrl: "#",
  ...
  {
    id: "fallback-kuliner-munggangsari-3",
    title: "Menjelajahi Ragam Kuliner Munggangsari: Warung Hangat dan Cita Rasa Desa",
    description:
      "Desa Munggangsari menyimpan cerita kuliner yang dekat dengan kehidupan warga. Deretan warung lokal menjadi ruang singgah, tempat cita rasa rumahan, obrolan hangat, dan keramahan desa bertemu setiap hari.",
    articleUrl: "#",
  ...
  {
    id: "fallback-kuliner-munggangsari-4",
    title: "Menjelajahi Ragam Kuliner Munggangsari: Warung Hangat dan Cita Rasa Desa",
    description:
      "Desa Munggangsari menyimpan cerita kuliner yang dekat dengan kehidupan warga. Deretan warung lokal menjadi ruang singgah, tempat cita rasa rumahan, obrolan hangat, dan keramahan desa bertemu setiap hari.",
    articleUrl: "#",
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white text-[#111711] transition-colors dark:bg-[#10150f] dark:text-[#f5f7f2]">
      ...
      <section className="relative min-h-[420px] overflow-hidden bg-[#142415] text-white md:min-h-[620px]">
        <Image
          src={heroImage}
          alt="Potensi kuliner Desa Munggangsari"
          fill
          priority
        ...
        <div className="relative flex min-h-[420px] flex-col justify-center px-6 pt-12 md:min-h-[620px] md:px-[40px] md:pt-0">
          <FadeIn className="max-w-[330px] md:max-w-3xl">
            ...
            <p className="mt-5 max-w-[320px] text-[0.74rem] font-semibold leading-5 text-white/86 md:mt-8 md:max-w-2xl md:text-lg md:leading-8">
              Menyingkap cita rasa lokal, keramahan warung, dan cerita warga
              yang menjaga denyut ekonomi desa tetap hidup.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-[#23672d] py-12 text-white md:py-16 dark:bg-[#1c4d25]">
        ...
        <FadeIn className="relative mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 text-center">
          ...
          >
            Ikuti Komunitas Artikel Desa Munggangsari
            <ArrowRightIcon className="motion-arrow h-5 w-5" />
          </a>
          <p className="max-w-xl text-sm font-semibold leading-6 text-white/78">
            Jadilah yang pertama mengetahui rilis warung baru, cerita desa, dan
            promo kuliner khusus langsung.
          </p>
        </FadeIn>
      </section>

      <FadeIn>
        <PublicFooter route="/munggangsari" />
      </FadeIn>
    </main>
  );
}
